...
const NoFraction = memo(() => {
  ...
  useEffect(() => {
    switch (tmType) {
      case 'answer':
        setEditElement(<EditAnswer noFraction={true} />)
        break
      case 'radio':
        setEditElement(<EditRadio noFraction={true} handleSubmitClick={handleSubmitClick}></EditRadio>)
        break
      case 'fill':
        setEditElement(<EditFill noFraction={true}></EditFill>)
        break
      case 'choice':
        setEditElement(<EditChoice noFraction={true}></EditChoice>)
        break
      default:
